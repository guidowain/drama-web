...
function createConfirmationEmail({
  ...
  const htmlBody = [
    ...
    '<tr>',
    '<td align="center">',
    '<a href="https://instagram.com/drama.com.ar" target="_blank" style="display:inline-block; padding:14px 22px; border-radius:10px; background:#f08eb5 url(\'https://res.cloudinary.com/dsqre3rmd/image/upload/Fondo_drama.png\') center center / cover no-repeat; color:#111111; font-size:13px; line-height:1.2; font-weight:800; letter-spacing:0.14em; text-transform:uppercase; text-align:center; text-decoration:none; white-space:nowrap;">Seguinos, no hay drama</a>',
    '</td>',
    '</tr>',
    '</table>',
